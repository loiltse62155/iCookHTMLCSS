...
}catch(e){}}if(isEvent){if(this.hasEvent(value.replace(/.+\./,""))){if(this.events.indexOf(evar)<0){this.events.push(evar);
...
},trackLink:function(e){var g=e.options.obj;
var f=(g&&g.href)?g:true,d=(g&&g.name)?g.name:"",b=e.options.defaultLinkType||"o",a=(f&&f.href)?s.lt(f.href):"";
if(a===""){a=b
}d=d||e.options.linkName||"default-link-name";
var c=s.tl(f,a,d);
